# Treino — PPL 2× por semana

## Regras de execução

- Sequência: **Push A, Pull A, Legs A, Push B, Pull B, Legs B, descanso**. Desloque o descanso se necessário, sem eliminar a recuperação semanal.
...
Faça as superséries sem descanso entre os dois exercícios e descanse 60–90 s somente após completar o par. Superséries são opcionais quando a academia estiver vazia; nunca agrupe supinos, puxadas, remadas, leg press, levantamento romeno ou afundo.

| Sessão | Pares permitidos |
| --- | --- |
...
Mantenha a carga até realizar o limite superior de repetições em todas as séries, dentro do RIR prescrito. Na sessão seguinte, aumente pela menor carga disponível e volte ao limite inferior da faixa. Se técnica, dor ou recuperação piorarem, mantenha ou reduza a carga.

## Push A

| Exercício | Séries × repetições | Descanso | RIR | Substituto Smart Fit |
| --- | ---: | ---: | ---: | --- |
| Supino inclinado em máquina | 3 × 6–10 | 2 min | 2 | Supino inclinado com halteres e banco ajustável |
...
## Legs A — ênfase em quadríceps

| Exercício | Séries × repetições | Descanso | RIR | Substituto Smart Fit |
| --- | ---: | ---: | ---: | --- |
| Leg press 45° | 3 × 8–12 | 2 min | 2 | Agachamento no smith, se disponível |
| Cadeira extensora | 2 × 10–15 | 90 s | 1–2 | Afundo búlgaro com halteres |
...
| Exercício | Séries × repetições | Descanso | RIR | Substituto Smart Fit |
| --- | ---: | ---: | ---: | --- |
| Supino reto com halteres | 3 × 8–12 | 2 min | 2 | Supino máquina reto |
...
## Legs B — ênfase em posteriores e glúteos
...
Na revisão semanal, reduza 30–50% das séries de trabalho por 5–7 dias se houver queda de desempenho em duas sessões equivalentes, fadiga que não melhora, piora contínua do sono ou dor articular. Dor aguda, formigamento ou perda de força não são sinais para “treinar por cima”: interrompa o exercício e procure avaliação profissional.
